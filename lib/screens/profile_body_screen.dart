              ...
              children: [
                Row(
                  children: [
                    ...
                    const Spacer(),
                    Text('065120129', style: vkTextCardBold),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('Muhamad Qodry Ruloh', style: vkTextLightGrey),
              ],
            ),
          ),
          ...
          Padding(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text('qodry', style: vkTextLightGrey),
              ],
            ),
          ),
          const Divider(color: Color.fromARGB(255, 86, 16, 126)),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Jl. Raya Cileungsi - Setu No. 79 Kec. Cileungsi Kab. Bogor',
